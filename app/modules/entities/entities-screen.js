...
appVersionEntityScreen,
  (
    ...
    //         <RoundedButton text="Wallet" onPress={walletEntityScreen} testID="walletEntityScreenButton" />
    //         <RoundedButton text="WalletTx" onPress={walletTxEntityScreen} testID="walletTxEntityScreenButton" />
    //         <RoundedButton text="PancardVerify" onPress={pancardVerifyEntityScreen} testID="pancardVerifyEntityScreenButton" />
    //         <RoundedButton text="BankDetailsVerify" onPress={bankDetailsVerifyEntityScreen} testID="bankDetailsVerifyEntityScreenButton" />
    <RoundedButton text="AppVersion" onPress={appVersionEntityScreen} testID="appVersionEntityScreenButton" />
  )
