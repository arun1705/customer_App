...
//   }
//   fetchCategories = () => {
//     this.props.getAllCategories({ page: this.state.page, sort: this.state.sort, size: this.state.size })
//   }
...
//       return {
//         done: nextProps.categories.length < prevState.size,
//         dataObjects: [...prevState.dataObjects, ...nextProps.categories],
//       }
//     }
//     return null
//   }
