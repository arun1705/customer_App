...
// import { ordDtlTranEntityDetailScreen } from '../../../navigation/layouts'

// import t from 'tcomb-form-native'

// import styles from './ord-dtl-trans-entity-edit-screen-style'

// let Form = t.form.Form

// class OrdDtlTranEntityEditScreen extends React.Component {
//   constructor(props) {
//     super(props)
...
//       this.props.getOrdDtlTran(props.data.entityId)
//     }
...
//     if (nextProps.ordDtlTran !== prevState.ordDtlTran && !prevState.isNewEntity) {
//       return { formValue: entityToFormValue(nextProps.ordDtlTran), ordDtlTran: nextProps.ordDtlTran }
//     }
//     return null
//   }
...
//       } else {
//         this.props.getAllOrdDtlTrans({ page: 0, sort: 'id,asc', size: 20 })
//         const entityId = this.props.ordDtlTran.id
//         const alertOptions = [{ text: 'OK' }]
//         if (!this.state.formValue.id) {
//           alertOptions.push({
//             text: 'View',
//             onPress: ordDtlTranEntityDetailScreen.bind(this, { entityId }),
//           })
//         }
...
//     const ordDtlTran = this.form.getValue()
//     if (ordDtlTran) {
//       // if validation fails, value will be null
//       this.props.updateOrdDtlTran(formValueToEntity(ordDtlTran))
//     }
//   }
...
//     fetching: state.ordDtlTrans.fetchingOne,
//     updating: state.ordDtlTrans.updating,
//     error: state.ordDtlTrans.errorUpdating,
//   }
// }
...
//     updateOrdDtlTran: ordDtlTran => dispatch(OrdDtlTranActions.ordDtlTranUpdateRequest(ordDtlTran)),
//   }
// }
